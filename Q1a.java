...
public class Q1a {
    ...
    public static void main(String[] args) {
        int k1 = 1, n1 = 2;
        System.out.println("Minimum measurements for k=" + k1 + ", n=" + n1 + ": " +minMeasurements(k1, n1)); // Output:
        int k2 = 2, n2 = 6;
        System.out.println("Minimum measurements for k=" + k2 + ", n=" + n2 + ": " + minMeasurements(k2, n2)); // Output:
        int k3 = 3, n3 = 14;
        System.out.println("Minimum measurements for k=" + k3 + ", n=" + n3 + ": " +minMeasurements(k3, n3)); // Output:
    }
